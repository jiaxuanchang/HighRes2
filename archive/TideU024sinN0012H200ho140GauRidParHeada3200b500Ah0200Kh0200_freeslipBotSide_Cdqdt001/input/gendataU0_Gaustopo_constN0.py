...
if is2D==0:
    b = 500
    a2 = 40**2*1000/b # a2=40**2*500/b whenever b changes a remains. # another set changing a, a2=40**2*1000/b 
    runname = 'TideU0%02dsinN0%03dH%03dho%03dGauRidParHeada%04db%03dAh%04dKh%04d_freeslipBotSide_Cdqdt%03d/' % (100*u0,1000*N0,H,h0,a2,b,10000*Ah,10000*Kh,1000*Cd)
else:
