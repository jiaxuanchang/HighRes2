...
if is2D==0:
    if isRplusH==1:
        b = 500
        a2 = 40**2*32000/b # a2=40**2*500/b whenever b changes a remains. # another set changing a, a2=40**2*1000/b 
        ...
        b = 500
        a2 = 40**2*500/b # a2=40**2*500/b whenever b changes a remains. # another set changing a, a2=40**2*1000/b 
        runname = 'TideU0%02dsinN0%03dH%03dho%03dNewParHeada%06db%03dAh%04dKh%04d_freeslipBotSide_Cdqdt%03d/' % (100*u0,1000*N0,H,h0,a2,b,10000*Ah,10000*Kh,1000*Cd)
    ...
    for i in range(len(xc)):
        for j in range(len(yc)):
            if isRplusH == 1:
                ...
                topo[j,i]=max(topowallN[j,i],topowallS[j,i])
