...
vpCbot=(Vbot-V0C)
absuH=(Ubot**2+Vbot**2)**0.5  #barotropic velocity magnitide
D0=rhoNil*Cd*absuH*(Ubot*U0C+Vbot*V0C)  #|U|*(uU+vV)
Dp=rhoNil*Cd*absuH*(Ubot*upCbot+Vbot*vpCbot+wbot*wbot)  #|U|*(u u'+v v'+w^2)
print(Dp)
