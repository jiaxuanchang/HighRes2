...
runname = 'TideU0%02dN0SimH%03dho%03dGauAh%04dKh%04da24000_freeslipBotSide_Cdqdt%03d/' % (100*u0,H,h0,10000*Ah,10000*Kh,1000*Cd)
comments = ''
...
if is2D==0:
    ...
    topowallN=10*(500*np.exp(-(xx/4000)**2)+(yy-1487))
    topowallN[topowallN>0]=0
    topowallN[topowallN<-H]=-H
    print(np.shape(topowallN))

    topowallS=10*(500*np.exp(-(xx/4000)**2)-(yy+1487))
