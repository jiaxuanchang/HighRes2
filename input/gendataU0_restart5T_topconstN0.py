...
runname = 'TideU0%02dN0LinTopConstH%03dho%03dAh%04dCdqdt003_advSch2/' % (100*u0,H,h0,10000*Ah)
comments = ''
...
if backupmodel:
    ...
    copy('./gendataU0_restart5T_topconstN0.py',outdir)
else:
      outdir=outdir+'input/'

outdir_p = '/home/jxchang/projects/def-jklymak/jxchang/HighRes1/input/'
print('outdir_p:'+str(outdir_p))
copy('./gendataU0_restart5T_topconstN0.py',outdir_p)
...
read_dir='/scratch/jxchang/HighRes1/results/TideU008N0LinTopConstH200ho140Ah0200Cdqdt003/python/'
